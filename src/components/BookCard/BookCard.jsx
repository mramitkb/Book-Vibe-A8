...
const BookCard = ({book}) => {
    ...
    return (
        <div className="border p-5 rounded-xl text-left space-y-5 mt-9">
            ...
            <p className="text-[#23BE0A] bg-[#F4FCF3] px-4 py-2 rounded-[30px] font-medium">{tags[0]}</p>
            <p className="text-[#23BE0A] bg-[#F4FCF3] px-4 py-2 rounded-[30px] font-medium">{tags[1]}</p>
            </div>
